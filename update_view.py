...
for file in files:
    ...
    html = html.replace("showNotification('View Details', 'Opening full request dossier...', 'visibility', '#3b82f6')", f"showNotification('Request #1041 Dossier', \"{mock_view}\", 'visibility', '#3b82f6')")
    
    with open(file, 'w', encoding='utf-8') as f:
        f.write(html)
print('Updated View buttons!')
